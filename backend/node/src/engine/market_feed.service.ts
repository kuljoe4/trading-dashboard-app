...
export class MarketFeedService {
  ...
  async start(config: SessionConfig, bc?: any) {
    ...
    // OPTIMIZATION: Start Watchlist Manager immediately to begin WebSocket ticker seeding
    // This allows symbol-specific @ticker streams to populate the cache before the 5s REST fallback.
