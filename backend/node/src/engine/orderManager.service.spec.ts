...
describe('OrderManagerService', () => {
  ...
  beforeEach(() => {
    ...
    service = new OrderManagerService(mockSignalEngine, { getSymbolFilters: (symbol: string) => ({ filters: [] }) } as any, { isRateLimited: () => false } as any, { log: jest.fn() } as any, { emit: jest.fn() } as any);
