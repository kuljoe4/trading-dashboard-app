...
describe('TradingSessionService Restart PnL Consistency', () => {
  ...
  beforeEach(() => {
    ...
    service = new TradingSessionService(
      ...
      {} as any, // signalEngine
      {} as any, // riskEngine
      { activeList: () => [], activeCount: () => 0, setEntering: jest.fn(), removeTrade: jest.fn(), recalculateTotalRisk: jest.fn() } as any, // positionTracker
      orderManager as any,
      ...
      { minimize: jest.fn() } as any, // engineBroadcaster
