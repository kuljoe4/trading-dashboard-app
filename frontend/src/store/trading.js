...
export const normalizeTrade = (t = {}, pt = null, isResuming = false) => {
  ...
  if (t._delta || t._thin) {
    ...
    return {
      ...
      exit_estimation: t.exit_estimation !== undefined ? t.exit_estimation : p.exit_estimation,
      exit_ts_ms,
      entry_ts_ms
    };
  }
