      ...
      {/* Modals & Drawers */}
        <Drawer.Root open={showConfig} onOpenChange={setShowConfig}>
          <Drawer.Portal>
            ...
            <Drawer.Content className="bg-background border-t border-border flex flex-col rounded-t-[32px] h-[96dvh] fixed bottom-0 left-0 right-0 z-[101] focus:outline-none shadow-[0_-20px_50px_rgba(0,0,0,0.5)] lg:max-w-[800px] lg:mx-auto">
